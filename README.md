...
**[To_Do_List]** is a Microverse exercises, where we build a To-Do-list application for storing a To-Do Tasks List.
...
```sh
cd capstone-project
git clone https://github.com/erickma1/To_Do_list.git
```
